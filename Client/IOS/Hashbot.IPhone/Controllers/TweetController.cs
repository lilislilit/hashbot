...
namespace Hashbot.IPhone
{
	public partial class TweetController : UIViewController
	{
		...
		void InitLayout()
		{
			...
			var tweetFont = Fonts.Helvetica(18);
			...
			var dateFont = Fonts.Helvetica(15);
			...
			var sourceFont = Fonts.HelveticaBold(18);
			...
			var urlFont = Fonts.Helvetica(15);
